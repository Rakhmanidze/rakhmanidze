...
- 📱 Currently building: **RateMan** —  a mobile app built with Kotlin Multiplatform for Android and iOS that tracks live currency exchange rates from banks and currency exchanges by integrating public APIs and scraping web pages, helping users find the best rates in Prague.
